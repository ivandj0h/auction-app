...
const RegisterPage: React.FC = (): JSX.Element => {
    ...
    return (
        <>
            <div className="min-h-screen flex items-center justify-center bg-primary-bg py-12 px-4 sm:px-6 lg:px-8 bg-gray-100">
                    ...
                    <div className="w-full rounded-8">
                        <div className="flex justify-center bg-white rounded-lg p-8 gap-[24px] shadow-2xl">
                            <form className="mt-2 w-full"  onSubmit={handleSubmit}>
                                <div className="mb-4">
                                    <span className="text-left text-lg font-bold text-gray-900 login-title">Register</span>
                                </div>
